...
//   workplaceAccidents.filter(function(el, i) {
//     return workplaceAccidents.indexOf(el) === i;
//   });
...
var removeDuplicates = () => workplaceAccidents.filter((elem, pos) => workplaceAccidents.indexOf(elem) == pos);
